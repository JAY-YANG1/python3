...
# 키보드로 정수를 하나 입력받아 그 값이 정수,
# 음수, 0인지 구분하는 프로그램을 작성하시오. 각각의 경우에 따라
# “정수입니다”, “음수입니다”, “0입니다”라고 출력하도록 한다.
...
# 은행이자가 연 6%라 가정할 때, 몇 년이 지나야 통장잔액이
# 지금의 2배를 넘는지 알아보는 프로그램을 작성하세요
balance = 25000
binter = 0.06
cnt = 0
